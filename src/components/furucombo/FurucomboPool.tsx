...
import { ComboList, PoolProps } from "@/pages/Flashloans";
  ...
  return (
    <div>
      <div className="mt-1 px-2">
        <div className="px-3">
          <div className="text-grey-200">{t("flashloans.pool")}</div>
          ...
          <div className="text-grey-200 mt-4">{t("flashloans.${poolType}")}</div>
          <div>
            {currentToken && (
              <div>
